...
──◌➗◌╯╿╰⋆⋆⋆╯╿╰◌➗◌──
 ...
 [$]_____________________________________________[$]
    ...
    Facebook : facebook.com/f44THH3RR

    Connect  : 03033421971

 [$]_____________________________________________[$]

 \033[1;32m Use Airplane Mod \033[1;32m
...
def R():
			...
			print("               \033[1;92m• FATHER • \033[1;97m")

			print (' [$]_____________________________________________[$]')

			print ("\033[1m [!] Owner    : JAWAD ALEE")

			print (" [!] BRAND   : JAWAD_ALEE")

			print(" [!] EXPIRE : Always Free")
			...
			print(" [2] make Supper File [ Ultimate ]")
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      ITX____JAWAD \033[1;37m")
